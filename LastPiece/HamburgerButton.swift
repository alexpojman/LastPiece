...
@objc class HamburgerButton : UIButton {
    ...
    override init(frame: CGRect) {
        ...
        let buttonColor = UIColor(red: 97/255, green: 173/255, blue: 1, alpha: 1)
        
        for layer in [ self.top, self.middle, self.bottom ] {
            layer.fillColor = nil
            layer.strokeColor = buttonColor.CGColor
            layer.lineWidth = 3
            layer.miterLimit = 3
            layer.lineCap = kCALineCapRound
            layer.masksToBounds = true

            let strokingPath = CGPathCreateCopyByStrokingPath(layer.path, nil, 3, CGLineCap.Round, CGLineJoin.Miter, 3)
        ...
        self.top.position = CGPointMake(26, 18)

        self.middle.position = CGPointMake(13, 27)
       self.middle.strokeStart = hamburgerStrokeStart
        ...
        self.bottom.position = CGPointMake(26, 36)
    }
